...
pub enum Fault {
    #[error("invalid request")] Invalid,
    #[error("request exceeds limit")] TooLarge,
    #[error("authentication or authority denied")] Denied,
    #[error("immutable intent or generation conflict")] Conflict,
    #[error("surface unavailable in this implementation slice")] Unavailable,
    #[error("budget or lifetime exhausted")] Exhausted,
    #[error("operation requires original-owner recovery")] Unknown,
}
